...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		<?php
			...
			the_content( sprintf(
				__( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'genietheme' ), 
	...
	<footer class="entry-footer">
		...
		<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'genietheme' ), __( '1 Comment', 'genietheme' ), __( '% Comments', 'genietheme' ) ); ?></span>
		<?php endif; ?>

		<?php edit_post_link( __( 'Edit', 'genietheme' ), '<span class="edit-link">', '</span>' ); ?>
	</footer><!-- .entry-footer -->
</article><!-- #post-## -->
